...
class OpenClawModelService {
  File get configFile =>
      File('${LocalEnvConfig.homePath}/.openclaw/openclaw.json');
  ...
  Future<List<Directory>> _openClawExtensionDirectories() async {
    final roots = <Directory>[
      Directory('${LocalEnvConfig.homePath}/.openclaw/extensions'),
      Directory(
        '${LocalEnvConfig.homePath}/.openclaw/node_modules/openclaw/extensions',
      ),
