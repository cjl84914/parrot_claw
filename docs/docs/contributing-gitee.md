...
> 欢迎参与 ParrotClaw 项目！本页介绍通过 [Gitee](https://gitee.com/alexcai/parrot_claw) 参与贡献的完整流程。

## 贡献流程

### 1. Fork 项目

在 [Gitee 项目主页](https://gitee.com/alexcai/parrot_claw) 点击右上角的 Fork 按钮，将仓库 fork 到你的 Gitee 账号下。
